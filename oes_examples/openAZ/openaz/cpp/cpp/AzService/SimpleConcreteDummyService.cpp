...
#include "OpenAzResourceQueryBuilder.h"
#include "AzStatusMessages.h"
#include "AzDataTypeId.h"
#include "AbstractService.h"

SimpleConcreteDummyService::SimpleConcreteDummyService() : AbstractService()
{

}

AzResponseContext* SimpleConcreteDummyService::decide(AzRequestContext* azReqCtx)
{
	if (azReqCtx == NULL)
		return NULL;  
...
AzRequestContext* SimpleConcreteDummyService::createAzRequestContext()
{
