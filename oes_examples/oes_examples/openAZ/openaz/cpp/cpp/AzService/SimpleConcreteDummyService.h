...
#ifndef SIMPLECONCRETEDUMMYSERVICE_H
#define SIMPLECONCRETEDUMMYSERVICE_H
...
class SimpleConcreteDummyService : AbstractService 
{
	public:
...
#endif // SIMPLECONCRETEDUMMYSERVICE_H
