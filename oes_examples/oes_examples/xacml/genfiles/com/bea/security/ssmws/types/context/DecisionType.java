...
public class DecisionType implements java.io.Serializable {
    ...
    public static final DecisionType NotApplicable = new DecisionType(_NotApplicable);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:oasis:names:tc:xacml:2.0:context:schema:os", "DecisionType"));
    }
    /**
