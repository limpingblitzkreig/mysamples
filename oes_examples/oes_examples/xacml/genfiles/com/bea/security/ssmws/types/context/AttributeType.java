...
public class AttributeType  implements java.io.Serializable {
    ...
    /**
     * Gets the dataType value for this AttributeType.
     * 
     * @return dataType
     */
    ...
    /**
     * Sets the dataType value for this AttributeType.
     * 
     * @param dataType
     */
    ...
    /**
     * Gets the issuer value for this AttributeType.
     * 
     * @return issuer
     */
    ...
    /**
     * Sets the issuer value for this AttributeType.
     * 
     * @param issuer
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:oasis:names:tc:xacml:2.0:context:schema:os", "AttributeType"));
