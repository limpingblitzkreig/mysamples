...
public class XacmlSample {
       ...
       // static final String ENV_ATTRIBUTE = XACML_NAMESPACE + "key";
        static final String ENV_ATTRIBUTE=XACML_NAMESPACE + "selectedorg";
	...
	EnvironmentType emptyEnv;
        ...
        actionWrite = createAction("access");
        resTest1 = createResource("test/assets/pdfs");
      System.out.println("created access  ");       
   
        AttributeType envAttr = createXacmlAttribute("11202", ENV_ATTRIBUTE, XML_INTEGER_TYPE);
        EnvironmentType env = new EnvironmentType(new AttributeType[]{envAttr});
        System.out.println("CReated attribute ");
      //        SubjectType sbjct = establishSession("sking", new String[]{"Administrators"}, atzSvc);
        SubjectType sbjct = establishSession("sking",new String[]{"Administrators"}, atzSvc);
