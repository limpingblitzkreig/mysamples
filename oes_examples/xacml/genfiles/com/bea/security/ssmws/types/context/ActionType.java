...
public class ActionType  implements java.io.Serializable {
    ...
    /**
     * Gets the attribute value for this ActionType.
     * 
     * @return attribute
     */
    ...
    /**
     * Sets the attribute value for this ActionType.
     * 
     * @param attribute
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:oasis:names:tc:xacml:2.0:context:schema:os", "ActionType"));
